...
while ($filename = shift @files) {
    ...
    $maxy=$maxy+5; #magic line added by Chao Gao, cgao3@ualberta.ca
    $miny=$miny-5; #magic line added by Chao Gao
    $minx=$minx-5; #magic line by Chao 
    $maxx=$maxx+5; #magic line by Chao
